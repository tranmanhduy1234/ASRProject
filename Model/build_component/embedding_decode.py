...
class Embedding_Decode(nn.Module):
...
class ConvSPE_Decode(nn.Module):
...
if __name__=="__main__":
    embed_layer = Embedding_Decode(vocab_size=40000, embed_dim=592, max_len=256, dropout=0.0).cuda()
